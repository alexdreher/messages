  ...
  def create
    ...
    respond_to do |format|
      if @admin_message.save
        format.html { redirect_to([:admin, @admin_message], :notice => 'Message was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @admin_message.update_attributes(params[:message])
        format.html { redirect_to([:admin, @admin_message], :notice => 'Message was successfully updated.') }
        format.xml  { head :ok }
      else
